        ...
        dataCall.enqueue(new Callback<ArrayList<Data>>() {
            ...
            public void onResponse(@NonNull Call<ArrayList<Data>> call, @NonNull Response<ArrayList<Data>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Snackbar.make(mainLayout, getString(R.string.successed), Snackbar.LENGTH_LONG).show();
                } else {
                    Snackbar.make(mainLayout, getString(R.string.failed), Snackbar.LENGTH_LONG).show();
                }
            }

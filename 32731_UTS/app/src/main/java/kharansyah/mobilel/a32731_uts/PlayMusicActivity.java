...
public class PlayMusicActivity extends AppCompatActivity {
    ...
    TextView song_name, artist_name, duration_played, duration_ended;
    ImageView cover_art, nextBtn, prevBtn;
    FloatingActionButton playPauseBtn;
    SeekBar seekBar;
    int position = -1;
    static ArrayList<MusicClass> listSongs = new ArrayList<>();
    static Uri uri;
    ...
    private void initViews() {
        ...
        duration_played = findViewById(R.id.startDuration);
        duration_ended = findViewById(R.id.endDuration);
    ...
    private void metaData(Uri uri) {
        ...
        duration_ended.setText(formattedTime(durationTotal));

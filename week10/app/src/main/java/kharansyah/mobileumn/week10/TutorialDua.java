...
public class TutorialDua extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_dua);
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<TutorialDua> mActivity;
        int mCounter = 0;

        public ContohLoader(@NonNull Context context, int n, TutorialDua main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<TutorialDua>(main);
        }

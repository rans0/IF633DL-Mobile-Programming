...
public class TutorialTiga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tutorial_tiga);
        ...
        btnStartService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TutorialTiga.this, CustomService.class);
                startService(intent);
            }
        });
